...
//{
    class BlowFish
    {
        ...
        public string Encrypt_CBC(string pt)
        {
            ...
            return ByteToHex(InitVector) + ByteToHex(Encrypt_CBC(strToBytes(pt)));
        }
        ...
        public string Decrypt_CBC(string ct)
        {
            ...
            return bytesToStr(Decrypt_CBC(HexToByte(ct.Substring(16)))).Replace("\0", "");
        }
        ...
        {
            return ByteToHex(Encrypt_ECB(strToBytes(pt)));
        }
        ...
        {
            return bytesToStr(Decrypt_ECB(HexToByte(ct))).Replace("\0", "");
        }
        ...
        public string Encrypt_CTR(string pt)
        {
            if (!IVSet)
                SetRandomIV();
            return ByteToHex(InitVector) + ByteToHex(Crypt_CTR(strToBytes(pt), 2));
        }
        ...
        {
            IV = HexToByte(ct.Substring(0, 16));
            return bytesToStr(Crypt_CTR(HexToByte(ct.Substring(16)), 2)).Replace("\0", "");
        }
        ...
        public byte[] SetRandomIV()
        {
			...
			InuRandom.instance.Bytes(InitVector);
            IVSet = true;
            return InitVector;
        }

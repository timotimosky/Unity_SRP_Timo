    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.B))
        {
            ...
            for (int i = 0; i < objCount; ++i)
            {
                ...
                //用MaterialPropertyBlock的目的是修改单体材质球属性时不生成新的材质球实例。因为材质球实例无法跟 
                //其他的原始材质球一起批处理，所以如果因为需要修改单个材质球属性造成的无法batch，用MaterialPropertyBlock可以解决
                //如果本身就没法batch的，用MaterialPropertyBlock 也不会有效果。
